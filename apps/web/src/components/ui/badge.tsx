...
const badgeVariants = cva(
  "inline-flex items-center justify-center select-none rounded-full whitespace-nowrap gap-1 w-fit shrink-0 [&>svg]:pointer-events-none overflow-clip",
  {
    ...
    compoundVariants: [
      ...
      { variant: "subtle", theme: "blue", className: "text-ink-blue-7 bg-surface-blue-2" },
      { variant: "subtle", theme: "green", className: "text-ink-green-7 bg-surface-green-2" },
      { variant: "subtle", theme: "amber", className: "text-ink-amber-7 bg-surface-amber-2" },
      { variant: "subtle", theme: "red", className: "text-ink-red-7 bg-surface-red-2" },
      { variant: "subtle", theme: "violet", className: "text-ink-violet-7 bg-surface-violet-2" },
      ...
      { variant: "outline", theme: "blue", className: "text-ink-blue-7 border-outline-blue-3" },
      { variant: "outline", theme: "green", className: "text-ink-green-7 border-outline-green-3" },
      { variant: "outline", theme: "amber", className: "text-ink-amber-7 border-outline-amber-3" },
      { variant: "outline", theme: "red", className: "text-ink-red-7 border-outline-red-3" },
      { variant: "outline", theme: "violet", className: "text-ink-violet-7 border-outline-violet-3" },
      // Ghost badges
      { variant: "ghost", theme: "gray", className: "text-ink-gray-6" },
      { variant: "ghost", theme: "blue", className: "text-ink-blue-7" },
      { variant: "ghost", theme: "green", className: "text-ink-green-7" },
      { variant: "ghost", theme: "amber", className: "text-ink-amber-7" },
      { variant: "ghost", theme: "red", className: "text-ink-red-7" },
      { variant: "ghost", theme: "violet", className: "text-ink-violet-7" },
    ],
    defaultVariants: {
      variant: "subtle",
      size: "md",
