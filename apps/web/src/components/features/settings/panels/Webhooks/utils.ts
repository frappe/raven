...
/** Curated per-doctype payload-field docs (description + example) shown in the
 *  Data tab's field-info dialog. The pickable field list itself comes from live
 *  doctype meta — this only enriches what the meta can't say. */
